...
public class ShapePGGUI
{
    ...
    public ShapeStatePGGUI activeState, previousState;
    ...
    public final Rect clickAreaShape  = new Rect();
    ...
    public ShapePGGUI(Rectc containingRect, HashMap<String, Object> themeing, String[] states)
    {
        ...
        for (String state : states) this.states.put(state, new ShapeStatePGGUI(state));
    ...
    public void setActiveState(String state)
    {
        if (this.states.containsKey(state) && !this.activeState.id().equals(state))
        {
            ...
            if (this.previousState != null && this.stateTransitionTimes.containsKey(statePair))
            {
                ...
                {
                    this.activeState.transition = new StateTransitionPGGUI(this.states, this.previousState.id(), this.activeState.id(), duration, 0);
                }
                else
                {
                    double progress = this.previousState.transition.remaining;
                    this.activeState.transition = new StateTransitionPGGUI(this.states, this.previousState.id(), this.activeState.id(), duration, progress);
                }
            }
        }
    }
