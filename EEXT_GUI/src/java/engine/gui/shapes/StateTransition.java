...
public class StateTransition
{
    ...
    public StateTransition(HashMap<String, ShapeState> states, String startState, String targetState, double duration, double progress)
    {
    ...
    public Texture produceBlendedResult()
    {
        ...
        renderer.blend().blendFunc(Blend.Func.SRC_COLOR, Blend.Func.DST_COLOR);
        renderer.blend().blendEquation(Blend.Equation.ADD);
